    ...
    <div className="space-y-6">
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 sm:p-8 text-center">
        <div className="flex flex-col items-center">
          ...
          <h4 className="text-base sm:text-lg font-medium text-gray-900 mb-2">Groups Management</h4>
          <p className="text-sm sm:text-base text-gray-600 max-w-sm px-2">
            This section will show the user&apos;s current and past group memberships, including
            their roles and administrative permissions within each group.
          </p>
