...
import { SettingsLoadingSkeleton } from '@/components/profile/settings/SettingsLoadingSkeleton';
...
export default function ProfileSettingsPage() {
  ...
  // Also intercept Next.js navigation
  useEffect(() => {
    ...
    // Note: This needs to be updated for App Router if needed
    // For now, the beforeunload event should handle most cases
    return () => {};
  }, [hasUnsavedChanges]);
